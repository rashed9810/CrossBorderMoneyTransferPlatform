...
const DepositLogTable: React.FC<DepositTableProps> = ({ data }) => {
    ...
    return (
        ...
        <div className='bg-gray-100 rounded-2xl p-4 mt-10'>
            <div>
                ...
                {/* 2nd row */}
                <div className='border-b border-black flex flex-row justify-between items-center text-xs py-3'>
                    <div className='flex flex-row gap-3 items-center'>
                        <div className='border-[1.5px] border-[#723EEB] flex justify-center items-center w-6 h-6 rounded-full'>
                ...
                <div className='border-b border-black flex flex-row justify-between items-center py-3 text-xs'>
                    ...
                    <p>{new Date(data?.createdAt).toLocaleDateString()} (MM/DD/YYYY)</p>
                </div>
                {/* 6th row */}
                <div className='border-b border-black flex flex-row justify-between items-center py-3 text-xs'>
                    <div className='flex flex-row gap-3 items-center'>
                    ...
                    <p>{new Date(data?.updatedAt).toLocaleDateString()} (MM/DD/YYYY)</p>
                </div>
            </div>
...
export default DepositLogTable;
